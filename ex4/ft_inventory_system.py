...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2025/12/31 15:10:46 by ayda              #+#    #+#              #
#    Updated: 2025/12/31 16:19:58 by ayda             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
def print_inventory(title, inventory):
    ...
    for name, data in inventory.items():
        ...
        total = qty * price
        print(f"{name} ({itype}, {rarity}): {qty}x @ {price} gold each = {total} gold")
...
bob = {
    "magic_ring": {"type": "accessory", "rarity": "rare", "quantity": 1, "price": 10}
}
...
print(f"Most valuable player: {most_value_name} ({most_value_amount} gold)")
