...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2026/01/01 14:44:44 by ayda              #+#    #+#              #
#    Updated: 2026/01/01 16:11:59 by ayda             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
def main():
    players = {
        ...
        "charlie": {
            ...
            "active": True,
            "region": "central",
            "achievements": ["level_10", "treasure_hunter", "boss_slayer", "speed_demon", "perfectionist", "combo_master", "no_damage"],
        },
        "diana": {
            "score": 2050,
            "active": False,
